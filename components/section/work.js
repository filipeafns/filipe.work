      ...
      <section className={cn(style.work, "grid")}>
        <div>
          ...
          <div>
            ...
            >
              <path
                d="M-6.1196e-07 14.2037L14 0.203735L28 14.2037L25.625 16.61L15.7188 6.70373L15.7187 62.0162L25.625 52.11L28 54.5162L14 68.5162L-2.37407e-06 54.5162L2.40625 52.11L12.2812 62.0162L12.2812 6.70373L2.40625 16.61L-6.1196e-07 14.2037Z"
                fill="black"
              />
            </svg>
          </div>
            ...
            <ul className={cn("grid")}>
              <li className={cn(style.tile, style.square)}>
                <video autoPlay muted loop>
                  <source src="FS_1.mp4" type="video/mp4" />
                </video>
              </li>
              ...
              <li className={cn(style.tile, style.square)}>
                <Image src={urbano} layout="fill" placeholder="blur" />
              </li>
              <li className={cn(style.tile, style.wideEnd)}>
                <Image src={clearworks} layout="fill" placeholder="blur" />
              </li>
              <li className={cn(style.tile, style.wideStart)}>
                <Image src={buzz} layout="fill" placeholder="blur" />
              </li>
            </ul>
          </div>
        </div>
